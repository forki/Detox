...
describe('buildDefaultArtifactsRootDirpath', () => {
  beforeEach(() => {
    process.env.DETOX_TEST_STARTED = '1572951641499';
  });

  afterAll(() => {
    delete process.env.DETOX_TEST_STARTED;
  });
  ...
  it('should fall back to Date.now if environment variable DETOX_TEST_STARTED is unset', () => {
    delete process.env.DETOX_TEST_STARTED;
